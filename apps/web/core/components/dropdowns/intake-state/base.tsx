...
// local imports
import { StateDropdownOptions } from "../state/state-options";
...
type TIntakeStateButtonContentProps = {
  ...
  iconSize: string;
  isInitializing: boolean;
  selectedState: IIntakeState | undefined;
};

const IntakeStateButtonContent = observer(function IntakeStateButtonContent(props: TIntakeStateButtonContentProps) {
